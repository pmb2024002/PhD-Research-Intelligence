...
def main():
    ...
    for _, row in df.iterrows():
        ...
        mito_level = int(row.get("mitochondrial_process_evidence_level", 0) or 0)
        senescence_level = int(row.get("senescence_evidence_level", 0) or 0)
        omics_level = int(row.get("omics_evidence_level", 0) or 0)

        if has_conservation and mito_level >= 2 and senescence_level >= 2 and omics_level >= 2:
            o1_level = 3
        elif has_conservation and mito_level >= 2 and senescence_level >= 2:
            o1_level = 2
        else:
            o1_level = 0
